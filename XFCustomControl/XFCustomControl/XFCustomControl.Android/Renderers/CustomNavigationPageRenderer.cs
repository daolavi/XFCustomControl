...
namespace XFCustomControl.Droid.Renderers
{
    public class CustomNavigationPageRenderer : NavigationPageRenderer
    {
        ...
        private void LastPage_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            else if (e.PropertyName == ContentPageBase.FormattedTitleProperty.PropertyName && (lastPage is ContentPageBase))
            {
                var cPage = lastPage as ContentPageBase;
            ...
            else if (e.PropertyName == ContentPageBase.SubtitleProperty.PropertyName && (lastPage is ContentPageBase))
            {
                var cPage = lastPage as ContentPageBase;
        ...
        void UpdateToolbarTitle(Page lastPage, AppCompatTextView titleTextView, AppCompatTextView subTitleTextView, Typeface originalFont, ColorStateList defaultColorStateList)
        {
            ...
            if (lastPage is ContentPageBase)
            {
                var cPage = lastPage as ContentPageBase;
        ...
        void UpdateToolbarSubtitle(ContentPageBase cPage, AppCompatTextView subTitleTextView, Typeface originalFont, ColorStateList defaultColorStateList)
        {
