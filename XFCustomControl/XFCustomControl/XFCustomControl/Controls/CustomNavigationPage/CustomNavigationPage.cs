...
namespace XFCustomControl.Controls
{
    public class CustomNavigationPage : NavigationPage
    {
        ...
        public static readonly BindableProperty SubtitleFontProperty = BindableProperty.CreateAttached("SubtitleFont", typeof(Font), typeof(CustomNavigationPage), Font.SystemFontOfSize(NamedSize.Medium));
        ...
        public CustomNavigationPage(ContentPageBase page) : base(page)
        {
